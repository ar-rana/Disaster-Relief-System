...
const RequestAid = ({ isOpen, setOpen }) => {
	...
	return (
		<div className="fixed inset-0 z-50 flex items-center justify-center">
			...
			></div>
			<div className="relative bg-white rounded-lg shadow-lg p-8 w-full max-w-md z-10" style={{ borderTop: "6px solid #33A1E0" }}>
				<button
				...
				<h2 className="text-2xl font-bold mb-6 text-[#33A1E0] text-center">Request Aid</h2>
